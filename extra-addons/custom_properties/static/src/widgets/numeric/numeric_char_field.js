...
export class CharField extends Component {
    static template = "numeric_widget.Numeric_CharField";
    static components = {
        TranslationButton,
    };
    static props = {
    ...
    onInputChange(event) {
        ...
        if (input.type !== 'password') {
            ...
            if (input.value.replace(/[^0-9]/g, '') !== input.value) {
                this.showErrorMessage('Numbers only allowed',);
            }
...
registry.category("fields").add("numeric", charField);
