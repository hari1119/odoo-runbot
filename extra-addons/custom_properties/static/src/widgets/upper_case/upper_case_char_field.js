...
export class CharField extends Component {
    ...
    onInputChange(event) {
        ...
        if (input.type !== 'password') {
            ...
            if (input.value.replace(/[^a-zA-Z0-9]/g, '') !== input.value) {
                this.showErrorMessage('Special character is not allowed');
            }
            let newValue = input.value.toUpperCase().replace(/[^a-zA-Z0-9]/g, '');
